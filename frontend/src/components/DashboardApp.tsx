...
export function DashboardApp() {
  ...
  return (
    <main className={drawerOpen ? "app-shell drawer-open" : "app-shell drawer-closed"}>
      ...
      {/* ── Social Footer (CyberShield Style) ─────────────────────────────────── */}
        ...
        <div className="app-footer-inner">
          ...
          <div className="app-footer-socials">
            ...
            <a
              ...
              title="Play Store"
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M3.18 23.76c.36.2.8.2 1.18-.02l12.84-7.41-2.8-2.8L3.18 23.76zM.54 1.3C.2 1.7 0 2.28 0 3v18c0 .72.2 1.3.54 1.7l.09.08 10.09-10.09v-.24L.63 1.22.54 1.3zm20.32 9.12l-2.88-1.66-3.17 3.17 3.17 3.16 2.9-1.67c.82-.48.82-1.52-.02-2zM4.36.26L17.2 7.67l-2.8 2.8L4.36.26z"/></svg>
              Play Store
            </a>
            <a
          ...
          <div className="footer-credits-container">
            <span className="footer-designed-by">
              Designed &amp; Built by <a href="https://github.com/khalid-hussain-dev" target="_blank" rel="noopener noreferrer">Khalid Hussain</a>
            </span>
            <span className="footer-copyright">
              &copy; {new Date().getFullYear()} NarrativeIQ &middot; Data Warehousing &amp; Big Data Lab
            </span>
          </div>
        </div>
      </footer>
